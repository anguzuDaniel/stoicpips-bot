            ...
            <div className="p-4 md:p-6 max-w-4xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="rounded-xl border border-border bg-card p-6 flex flex-col items-center text-center space-y-4 hover:border-primary/50 transition-colors">
                        ...
                        <a href="mailto:support@stoicpips.com" className="text-sm font-medium text-primary hover:underline">
                ...
                <div className="rounded-lg bg-blue-500/10 p-4 border border-blue-500/20 text-sm text-blue-600 dark:text-blue-400">
                    <p className="flex items-start gap-2">
                        ...
                        <span>
                            <strong>Note:</strong> We are constantly updating SynthBot. If you encounter a bug, please report it via email with a screenshot so we can fix it in the next update.
                        </span>
                    </p>
                </div>
            </div>
