 ...
 */
const executeTradeOnDeriv = async (userId, signal, config, deriv) => {
    try {
        if (!deriv) {
        ...
        botLogger_1.BotLogger.log(userId, `Trade executed: Contract #${tradeResult.buy?.contract_id}`, 'success');
        return {
