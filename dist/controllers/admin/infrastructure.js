...
exports.getInfrastructureHealth = void 0;
 ...
 */
const getInfrastructureHealth = async (req, res) => {
    try {
        const healthChecks = [];
        ...
        try {
            ...
            const aiResponse = await axios_1.default.get(`${aiEngineUrl}/health`, { timeout: 5000 });
        ...
        await (0, auditLog_1.logAdminAction)(req.user.id, 'CHECK_INFRASTRUCTURE_HEALTH');
        res.json({
...
exports.getInfrastructureHealth = getInfrastructureHealth;
