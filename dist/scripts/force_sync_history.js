...
const syncTrades_1 = require("../controllers/bot/history/syncTrades");
const forceSync = async () => {
    ...
    try {
        ...
        if (!userId) {
            ...
            const { data: profiles } = await supabase_1.supabase.from('profiles').select('id, email').limit(1);
        ...
        await (0, syncTrades_1.syncTrades)(userId);
